...
// funcional
export function getBioFunc(id: number): string {
...
// funcional
export function getNameFunc(id: number): string {
...
// funcional
export function removeItemFunc(id:number): void {
...
// funcional
export function updateItemFunc(id:number, newName?: string, newBio?: string): void{
